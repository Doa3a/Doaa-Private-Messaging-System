...
<br><a style="color:blue;">List of your recieved messages:</a><br><br>
			<table class="fixed" border="1px" frame="box">
				<col width="50px" />
				<col width="200px" />
				<col width="60px" />
				<col width="50px" />
...
<?php
		...
		$sql = "SELECT * FROM `messages` WHERE `To_user`= '".$_SESSION['user_name']."'";
